...
public class ArticleController {
	...
	public List<Article> queryAll(String seekContent) throws Exception{
		List<Article> selectArticle = as.queryArticle(seekContent);
	...
	public String deleteArticle(@PathVariable Integer id, OutputStream os) throws Exception{
		try {
			as.deleteArticle(id);
			os.write("1".getBytes("UTF-8"));
		} catch (Exception e) {
	...
	public String updateArticle(@PathVariable Integer id, String title, String content, OutputStream os) throws Exception{
		try {
